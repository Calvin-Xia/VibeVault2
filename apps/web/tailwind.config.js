...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        /* <alpha-value> 模式:让 bg-card/80 等透明度修饰符真正生效 */
      ...
      fontFamily: {
        sans: ['var(--font-sans)', 'Noto Sans SC', 'Space Grotesk', 'system-ui', 'sans-serif'],
        display: ['var(--font-display)', 'Noto Sans SC', 'system-ui', 'sans-serif'],
